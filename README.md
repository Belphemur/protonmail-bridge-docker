...
![version badge](https://img.shields.io/docker/v/belphemur/protonmail-bridge)
![image size badge](https://img.shields.io/docker/image-size/belphemur/protonmail-bridge/build)
![docker pulls badge](https://img.shields.io/docker/pulls/belphemur/protonmail-bridge)
...
```
docker run --rm -it -v protonmail:/root ghcr.io/belphemur/protonmail-bridge init
```
...
```
docker run -d --name=protonmail-bridge -v protonmail:/root -p 1025:25/tcp -p 1143:143/tcp --restart=unless-stopped ghcr.io/belphemur/protonmail-bridge
```
...
```
docker run -d --name=protonmail-bridge -v protonmail:/root -p 127.0.0.1:1025:25/tcp -p 127.0.0.1:1143:143/tcp --restart=unless-stopped ghcr.io/belphemur/protonmail-bridge
```
